const { insertServices, listServices, updateServices, constServices } = require('../services/const.services');
 ...
 * 
 */
 async function constHelper(params) {
    try {
        var constService = await constServices(params);
        return constService;
    } catch (error) {
        console.log(error)
        return {
...
module.exports = { insertHelper, viewHelper,  updateHelper, constHelper };