const { insertServices, listServices, updateServices, deleteServices, getServices, listOneServices } = require('../services/player-transaction.services');
 ...
 * 
 */
 async function viewOneHelper(params) {
    try {
        var listService = await listOneServices(params);
        return listService;
    } catch (error) {
        return {
            status: false,
 ...
 */
 async function getHelper(params) {
    try {
        var upadteService = await getServices(params);
        return upadteService;
    } catch (error) {
        console.log(error)
        return {
...
module.exports = { insertHelper, viewHelper,  updateHelper, deleteHelper, getHelper, viewOneHelper };